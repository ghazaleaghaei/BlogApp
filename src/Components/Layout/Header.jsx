...
function Header() {
    ...
    return (
        <header className={`shadow-md bg-inherit mb-10 sticky top-0 border-b border-b-secondary-300 bg-white z-10 duration-300 ${isLoading ? "blur-sm opacity-70" : "opacity-100 blur-0"}`}>
